...
public class AdMetadataException extends Exception {
    ...
    public final static AdMetadataException InvalidContentTypeException = new AdMetadataException("Invalid content type");
    public final static AdMetadataException InvalidRequestTimeException = new AdMetadataException("Invalid request time");
    public final static AdMetadataException InvalidWidthException = new AdMetadataException("Invalid width");
    public final static AdMetadataException InvalidHeightException = new AdMetadataException("Invalid height");
